...
class model_optim_state_info(object):
    ...
    def model_init(self, args):
        ...
        elif args.model == "ResNet18_rot":
            self.model = ResNet18_rot(num_classes=args.clsN)
        elif args.model == "ResNet34_rot":
            self.model = ResNet34_rot(num_classes=args.clsN)
