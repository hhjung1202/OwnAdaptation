...
parser.add_argument('--noise-rate', '--learning-rate', default=1e-1, type=float, help='Noise rate')
...
def main():
    ...
    train_Disc(args, state_info, True_loader, Fake_loader, Noise_Test_loader) # 각각이 독립적인 실험 param 이 필요하다 .
    train_Noise(args, state_info, Noise_loader, Test_loader) # all 
    train_Base(args, state_info, All_loader, Test_loader) # all 
