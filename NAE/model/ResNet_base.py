...
def ResNet18_P(memory=1, num_classes=10, z=64):
    return ResNet(BasicBlock, [2,2,2,2], memory=memory, num_classes=num_classes, z=z)

def ResNet34_P(memory=1, num_classes=10, z=64):
    return ResNet(BasicBlock, [3,4,6,3], memory=memory, num_classes=num_classes, z=z)